...
public class Main {
    public static void main(String[] args) {
        ...
        Student student = new Student("S001","Kawishkia",null,cRoom);
        Student student1 = new Student("S002","Nadun",null,cRoom);
        Student student2 = new Student("S003","Kawishkia",null,cRoom);
